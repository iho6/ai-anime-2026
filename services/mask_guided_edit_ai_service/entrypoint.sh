...
if $comfy_enabled; then
    ...
    echo "Starting ComfyUI for mask-guided-edit: --disable-metadata ${comfy_args[*]}"
...
exec python3 -m services.mask_guided_edit_ai_service.serverless "${serverless_args[@]}"
