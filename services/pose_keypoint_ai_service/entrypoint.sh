...
if $comfy_enabled; then
    ...
    echo "Starting ComfyUI for pose-keypoint: --disable-metadata ${comfy_args[*]}"
...
exec python3 -m services.pose_keypoint_ai_service.serverless "${serverless_args[@]}"
