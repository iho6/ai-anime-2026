...
if $comfy_enabled; then
    ...
    echo "Starting ComfyUI for anime-img-gen: --disable-metadata ${comfy_args[*]}"
...
exec python3 -m services.anime_img_gen_ai_service.serverless "${serverless_args[@]}"
