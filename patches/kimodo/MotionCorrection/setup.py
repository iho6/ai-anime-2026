...
# Parent kimodo/ contains shared build_cmake.py for standalone MotionCorrection installs.
_KIMODO_ROOT = Path(__file__).resolve().parents[1]
if str(_KIMODO_ROOT) not in sys.path:
    sys.path.insert(0, str(_KIMODO_ROOT))

from build_cmake import (
    extra_cmake_args_from_env,
    python_cmake_args,
